...
<div class="container pt-5">
    ...
    <div class="row text-center">
        ...
        <div class="col-xl-3 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm p-5">
                <img src="<?= URL ?>public/assets/images/teams/receptionniste.jpg" alt="" width="100"
        ...
        <div class="col-xl-3 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm p-5">
                <img src="<?= URL ?>public/assets/images/teams/menage.jpg" alt="Femme de ménage" width="100"
                     class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                <h5 class="mb-0">Tom Sunderland</h5>
                <span class="small text-uppercase text-muted">Réponsable service ménage</span>
            </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-5 sizeTeam">
            <div class="bg-white rounded shadow-sm pt-5 px-4">
    ...
    <!-- 3ème section -->
    <section class="container px-4 pt-5" id="hanging-icons">
